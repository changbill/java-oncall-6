...
public class OnCallControllerFactory {
    ...
    public static OnCallController getController() {
        ...
        OnCallCalculateService onCallCalculateService = new OnCallCalculateService(onCallRepository);

        return new OnCallController(onCallSaveService, onCallCalculateService);
    }
